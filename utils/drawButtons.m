...
%             'baseColor',[255 255 255]);
        DrawFormattedText(mainWindow, num2str(button), ...    % downgrade for compatibility
          buttonAreas(1, button) + button_width/2, ...
          buttonAreas(2, button) + button_height/2, ...
          [0 0 0]);
    else
...
%             'yalign','center',...
%             'baseColor',[255 255 255]);
        DrawFormattedText(mainWindow, sprintf('%d +', button), ...    % downgrade for compatibility
          buttonAreas(1, button) + button_width/2, ...
          buttonAreas(2, button) + button_height/2, ...
          [0 0 0]);
    end        
